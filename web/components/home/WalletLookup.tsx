...
export function WalletLookup() {
  ...
  return (
    <div className="home-lookup">
      <div className="flex items-center justify-between gap-3"><h2>Check a wallet</h2><Icon name="wallet" size={21} className="text-fg-subtle" /></div>
